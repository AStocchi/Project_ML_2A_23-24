...
def get_datasets(args, num, ds_load="null"):
    ...
    if args.dataset == 'idda':
        ...
        if setting == "centralized":
            ...
            test_data_dir = os.path.join('data', 'femnist', 'data', 'iid', 'test')
            if domain_gen == False:  # se stiamo facendo run NON Domain Generalization -> cambia la cartella dei dataset da usare
...
def main():
    ...
    if domain_gen:
        ...
        while num_clients <= 35:

            print('Generate datasets...')
            train_datasets, test_datasets = get_datasets(args, num_clients)
            print('Done.')

            print('Generate clients...')
            train_clients, test_clients = gen_clients(args, train_datasets, test_datasets, s_train_clients[0].model)  # con modello parz. trainato passato da una "generazione" all'altra
            ...
            if num_clients == 4 or num_clients == 35:
                breakpoint()
                print(vect_metrics)
